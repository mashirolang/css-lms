...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-700 via-slate-800 to-slate-950 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-center text-white max-w-sm">
          ...
          <p className="text-xl text-slate-300 mb-1">CCS LMS</p>
          <p className="text-sm text-slate-400 mb-10">System administration, user management, and oversight.</p>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="pb-2 text-center">
              ...
              <CardDescription>Access the CCS LMS admin dashboard</CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" type="email" placeholder="admin@school.edu" className="pl-9"
                ...
                <Button type="submit" className="w-full bg-slate-800 hover:bg-slate-900" size="lg" disabled={loading}>
          ...
          <p className="mt-4 text-center text-xs text-slate-400">© 2024 CCS LMS — College of Computer Studies</p>
        </div>
      </div>
    </div>
  );
